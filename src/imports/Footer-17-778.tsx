import svgPaths from "./svg-opchhfjrnf";
...
function Group1() {
  return (
    <div className="absolute contents left-[811px] top-[52px]">
      <AppStore1 />
      <div className="absolute flex inset-[30.95%_7.09%_31.55%_76.97%] items-center justify-center">
        <div className="flex-none h-[63px] scale-y-[-100%] w-[218.077px]">
          <Group2 />
        </div>
      </div>
    </div>
...
function List() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',_sans-serif] font-normal gap-[4px] items-start justify-start leading-[1.4] not-italic relative shrink-0 text-[20px] text-white w-full" data-name="list">
...
function List4() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',_sans-serif] font-normal gap-[4px] items-start justify-start leading-[1.4] not-italic relative shrink-0 text-[20px] text-white w-[277px]" data-name="list">
      <p className="min-w-full opacity-60 relative shrink-0" style={{ width: "min-content" }}>
        FAQs
      </p>
      <p className="min-w-full opacity-60 relative shrink-0" style={{ width: "min-content" }}>
...
function Nav() {
  return (
    <div className="absolute content-stretch flex gap-[83px] items-start justify-start left-[9px] top-[218px] w-[1365px]" data-name="nav">
      <Section />
      <Section1 />
      <Section2 />
      <Section3 />
...
function List5() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Medium',_sans-serif] font-medium gap-[4px] items-end justify-start leading-[1.4] not-italic relative shrink-0 text-[#00bdd7] text-[24px] text-nowrap whitespace-pre" data-name="list">
...
function Contacts() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[13px] items-end justify-start left-[1164px] top-[32px] w-[260px]" data-name="CONTACTS">
      <Col />
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute content-stretch flex gap-[50px] items-start justify-start left-[1194px] top-[147px]" data-name="group">
      <Section5 />
    </div>
  );
}
...
export default function Footer() {
  return (
    <div className="bg-[#03033b] relative size-full" data-name="footer">
      <Top />
      <Contacts />
      <Logo />
      <Group5 />
