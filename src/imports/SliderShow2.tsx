import svgPaths from "./svg-emaxqw64ar";
import imgImage6 from "figma:asset/e96614b65f7e58769d2031b40b9b6a38d0f222d9.png";
import imgImage4 from "figma:asset/a4b946f238adec33a9c05d3a1c7f41fe4d8b1eb0.png";
import imgImage5 from "figma:asset/1a63f359de314a186c5388b47085743166b481a0.png";
import imgImage7 from "figma:asset/08c3adfaf682d943fd57263728b75106ff53584e.png";
import imgImage8 from "figma:asset/a78d12acd8013335a708b1d3299fa67dea821c2f.png";
import imgImage9 from "figma:asset/048763dcef3dac0c99bc05231149ecce12c9363a.png";
...
function TexteSlider() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start justify-start left-[53px] top-[53px] w-[804px]" data-name="texte slider">
...
function Slideshow() {
  return (
    <div className="h-[412px] relative shrink-0 w-[274px]" data-name="Slideshow">
...
function Slide() {
  return (
    <div className="absolute content-stretch flex gap-[30px] items-center justify-start left-1/2 top-[424px] translate-x-[-50%]" data-name="slide">
      <Slideshow />
      <Slideshow1 />
      <Slideshow2 />
      <Slideshow3 />
...
function Frame18277() {
  return (
    <div className="absolute h-[37px] top-[884px] translate-x-[-50%] w-[211px]" style={{ left: "calc(50% - 0.5px)" }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 211 37">
        <g id="Frame 18277">
          <rect fill="var(--fill-0, #4A4A4A)" height="37" rx="18.5" width="211" />
          <circle cx="45" cy="18" fill="var(--fill-0, #16BDA0)" id="3rd" r="10" />
          <circle cx="75.2" cy="18" fill="var(--fill-0, #F9F9F9)" id="3rd_2" r="10" />
          <circle cx="105.4" cy="18" fill="var(--fill-0, #F9F9F9)" id="3rd_3" r="10" />
          <circle cx="135.6" cy="18" fill="var(--fill-0, #F9F9F9)" id="3rd_4" r="10" />
          <circle cx="165.8" cy="18" fill="var(--fill-0, #F9F9F9)" id="3rd_5" r="10" />
        </g>
      </svg>
    </div>
  );
...
export default function SliderShow2() {
  return (
    <div className="bg-[#f8f8f8] relative size-full" data-name="SLIDER SHOW2">
      <Background />
